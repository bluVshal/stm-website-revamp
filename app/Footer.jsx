      ...
      <Container>
        <div className="rounded-[2rem] bg-[#414042] p-8 text-white md:p-10">
          <div className="grid gap-8 sm:grid-cols-2 sm:gap-10 xl:grid-cols-4">
            ...
            <FooterColumn title="Services" items={[{title:"SEO", link:"/services#seo"}, {title:"Digital Marketing", link:"/services#digital-marketing"}, {title:"CRM", link:"/services#crm"}, {title:"Graphic Design", link:"/services#graphic-design"}, {title:"Analytics & CRO", link:"/services#analytics"}]} />

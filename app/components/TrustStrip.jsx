  ...
  return (
    <div className="px-6 md:px-8">
      <Container>
        ...
        >
          <div>
            <div className="text-sm font-medium text-[#414042]">Trusted by growth-focused brands across multiple industries</div>
          ...
          <div className="flex flex-wrap gap-3 md:justify-end">
            {["50+ Campaigns", "Multi-channel Expertise", "KPI-led Growth"].map((item) => (
              <span key={item} className="rounded-full bg-[#F1F4F2] px-4 py-2 text-sm font-medium text-[#414042]">
                {item}
              </span>
            ))}
          </div>

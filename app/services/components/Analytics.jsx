          ...
          <Container>
            <div className="items-center rounded-[1.25rem] sm:rounded-[2rem] border border-[#E6EBE7] bg-white/80 p-5 shadow-[0_16px_40px_rgba(24,32,28,0.06)] backdrop-blur sm:p-6 md:p-8 lg:p-10">
              <motion.div initial="hidden" animate="visible" variants={stagger} className="text-center">
                ...
                >
                  <span>It’s not just about traffic—it’s about results.</span>
                </motion.h1>
                <motion.p variants={fadeUp} className="mx-auto mt-4 sm:mt-6 max-w-xl text-base sm:text-lg leading-7 sm:leading-8 text-[#5E645F]">
                  We analyze how people use your website and find ways to improve it so more visitors take action, whether that’s signing up, buying, or contacting you. From A/B testing to user behavior analysis, we help you turn more visitors into customers.
                </motion.p>
              </motion.div>
